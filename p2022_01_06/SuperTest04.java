...
// super : 부모 클래스를 의미하는 래퍼런스 변수 
// super를 사용 할때는 자식 클래스의 메소드 안에서 사용할 수 있다.
// super.x는 부모 클래스의 은닉된 필드를 접근 할 때 사용된다.

//  System.out.println(); 오류 발생
  
// super.은 쉐도우 변수(은닉 변수)를 불러와서 사용한다.
// super.은 자식클래스 메소드 안에서만 쓸 수 있다. 
  public void print02( ){
