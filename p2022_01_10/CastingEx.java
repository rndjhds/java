...
//		add(Object e)
		lt.add(new String("자바")); // 업캐스팅 : 메소드의 매개변수에서 업캐스팅이 많다
		lt.add("오라클");
		lt.add("JSP");
		lt.add("스프링");
		lt.add("파이썬");
...
//		Object get(index)
		for (int i = 0; i < lt.size(); i++) {
			...
			String str = (String) lt.get(i); // 다운 캐스팅 : 메소드앞에 자료형에서 다운 캐스팅이 많다.
...
//			Object obj = ls.get(i);
			...
			// 다운 캐스팅 + 언박싱
			int n2 = ((Integer) ls.get(i)).intValue();
			// 다운 캐스팅 + 자동언박싱
			int n3 = ((Integer) ls.get(i));
